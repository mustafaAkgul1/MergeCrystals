...
public class DragCamera2D : MonoBehaviour
{
    ...
    */
    ...
    void Update()
    {
        ...
        if (GameManager._instance.heldOrbEndOfMergePhase == null && GameManager._instance.heldCrystalHarvester == null)
        {
            dragEnabled = true;
        }
        else
        ...
        if (edgeBoundary > 0 && dragEnabled == false)
        {
            edgeScroll();
        }
    ...
    public void panControl()
    {
        ...
        { 
            ...
            {
                float x = touch.deltaPosition.x * dragSpeed * 0.02f;
